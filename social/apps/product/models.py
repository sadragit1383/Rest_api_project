...
class Brand(models.Model):
    ...
    image_name = models.ImageField(upload_to=image_file.upload_to, verbose_name='brand image',default='')
...
class GroupProduct(models.Model):
    ...
    image_name = models.ImageField(verbose_name='image of group',upload_to=file_upload.upload_to,default='')
    slug = models.CharField(max_length=100,verbose_name='slug url')
    register_date = models.DateTimeField(verbose_name='Confirm time!', default=timezone.now)
    update_date = models.DateTimeField(auto_now=True, verbose_name='update time')
    is_active = models.BooleanField(default=True,verbose_name='status of brand')
    group_parent = models.ForeignKey('GroupProduct',on_delete=models.CASCADE,verbose_name='Parent',null=True,blank=True,
...
class Product(models.Model):
    ...
    image_name = models.ImageField(upload_to=file_upload.upload_to,verbose_name='image of product',default='')
